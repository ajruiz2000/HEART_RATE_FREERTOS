...
/* USER CODE BEGIN PFP */
/* FREERTOS_MARK */
extern void BleStack_Process_BG_Entry(void* thread_input);
extern void Ble_UserEvtRx_Entry(void* thread_input);
extern void APP_BLE_AdvLowPower_Entry(void* thread_input);
extern void HRS_APP_Measurements_Entry(void* thread_input);
...
void APP_BLE_Init(void)
{
  ...
  if (HOST_BLE_Init() == 0u)
  {
	...
	UTIL_TIMER_Create(&(bleAppContext.TimerAdvLowPower_Id), INITIAL_ADV_TIMEOUT, UTIL_TIMER_ONESHOT, &APP_BLE_AdvLowPower_timCB, 0);
